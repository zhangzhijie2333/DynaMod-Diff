...
class DatasetCatalog:
    def __init__(self, ROOT):
        ...
        self.Mvtec_anomaly = {   
            "target": "dataset.dataset_sem_data_aug_validmask.MvtecSemanticDataset",
            "train_params":dict(
                image_rootdir = os.path.join(ROOT,'Source_Images'),
                sem_rootdir = os.path.join(ROOT,'Ground_truth'),
