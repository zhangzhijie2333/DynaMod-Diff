...
class Decoder(nn.Module):
    def __init__(
        ...
        **ignorekwargs,
        ...
        self.decoder_mask_use_affine = decoder_mask_use_affine
    ...
    def _build_decoder_mask_modules(self):
        ...
        if self.debug_decoder_mask:
            print(
                f"[DecoderMaskBuild][SUM] blocks={len(self.up)} hooked={total_hooked} use_highfreq={self.decoder_mask_use_highfreq_cond}"
            )
